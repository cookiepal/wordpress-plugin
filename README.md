...
A lightweight WordPress plugin that injects the CookiePal consent banner script into your site’s header for GDPR, LGPD, and privacy compliance workflows. It lets you configure your CookiePal Website ID right from the WP admin settings.
